...
int main(int argc, char** argv) 
{
    ...
    try {
        ...
        shared_ptr<File> ptop_f1 = make_shared<File>(string("top-File1"), string("12-12-2013"), file_size);
        
        shared_ptr<File> ptop_f2  = make_shared<File>(string("top-File2"), string("12-10-2013"), file_size);
         ...
         */  
        shared_ptr<Directory> psubdir_mid = mkdir(&top, "subdir-mid"); 
           
        shared_ptr<Directory> psubdir_lower1 = mkdir(&top, "subdir-mid/subdir-lower1");

        
        /* Node *psubdir_lower1 = psubdir_mid->getChild(0); // alternative to line above. */

        shared_ptr<File> psubdir_lower1_f1 = make_shared<File>(string("subdir-lower1-File1"), string("12-12-2013"), file_size);
        
        shared_ptr<File> psubdir_lower1_f2 = make_shared<File>(string("subdir-lower1-File2"), string("12-10-2013"), file_size);
        
        psubdir_lower1->adopt(psubdir_lower1_f1);

        psubdir_lower1->adopt(psubdir_lower1_f2);
        
        shared_ptr<File> psubdir_mid_f1 = make_shared<File>(string("subdir_mid-File1"), string("12-12-2013"), file_size);
    
        shared_ptr<File> psubdir_mid_f2 = make_shared<File>(string("subdir-mid_File2"), string("12-10-2013"), file_size);
        ...
        shared_ptr<File> psubdir_lower2_f1 = make_shared<File>(string("subdir-lower2-File1"), string("12-12-2013"), file_size);
        
        shared_ptr<File> psubdir_lower2_f2 = make_shared<File>(string("subdir-lower2-File2"), string("12-10-2013"), file_size);
        
        psubdir_lower2->adopt(psubdir_lower2_f1);

        psubdir_lower2->adopt(psubdir_lower2_f2);
              
        shared_ptr<File> ptop_f3 = make_shared<File>(string("top-File3"), string("12-12-2013"), file_size);
        
        shared_ptr<File> ptop_f4  = make_shared<File>(string("top-File4"), string("12-10-2013"), file_size);
